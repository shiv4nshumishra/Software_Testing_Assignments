package com.shivanshu.TestNG.Group;
...
public class BrowserBasedGroupTest {
	...
	String EdgePath = "Drivers/msedgeodriver.exe";
	...
	@Test(groups = "EdgeOnly", dependsOnMethods="launchEdgeTest", priority=1)
	public void testFaceBookHomePage() {
		String expected = "Facebook – log in or sign up";
		assertEquals(driverTwo.getTitle(), expected);
	}
	
	@Test(groups = "EdgeOnly", dependsOnMethods="launchEdgeTest", priority=2)
	public void testFailureLogin() {
		driverTwo.findElement(By.id("email")).sendKeys("abc@gmail.com");
		driverTwo.findElement(By.id("pass")).sendKeys("abc");
