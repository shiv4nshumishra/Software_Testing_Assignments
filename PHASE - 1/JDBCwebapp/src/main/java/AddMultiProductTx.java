...
public class AddMultiProductTx extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			...
			String query1 = "INSERT into eproducts(product_name, product_desc, price) values('" + productName1 + "','"
					+ productDec1 + "'," + productPrice1 + ")";

			String query2 = "INSERT into eproducts(product_name, product_desc, price) values('" + productName2 + "','"
					+ productDec2 + "'," + productPrice2 + ")";

			String query3 = "INSERT into eproducts(product_name, product_desc, price) values('" + productName3 + "','"
					+ productDec3 + "'," + productPrice3 + ")";
